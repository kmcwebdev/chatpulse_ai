...
export default function ConversationTab(props : ConversationTabProps) {
	return(<Link role="tab" className={`tab flex space-x-2 transition-colors hover:text-black hover:border-black ${props.isSelected ? "tab-active" : ""}`} href="#" onClick={props.onClick}>
