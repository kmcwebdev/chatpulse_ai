...
export default function ConversationTab(props : ConversationTabProps) {
	return(<Link role="tab" className={`tab flex space-x-1 min-w-fit w-full transition-colors hover:text-black hover:border-black ${props.isSelected ? "tab-active" : ""}`} href="#" onClick={props.onClick}>
